  ...
  describe 'class methods' do
    describe 'count_by_level_of_interest method' do
      it 'should have count of jobs by level_of_interest' do
        ...
        job_2 = company_1.jobs.create(title: "QA", level_of_interest: 50, city: "Denver", category_id: category_2.id)
        job_3 = company_1.jobs.create(title: "Research", level_of_interest: 10, city: "Denver", category_id: category_2.id)
        job_4 = company_2.jobs.create(title: "Dev Ops", level_of_interest: 40, city: "Denver", category_id: category_2.id)
        job_5 = company_2.jobs.create(title: "Research", level_of_interest: 30, city: "Denver", category_id: category_1.id)
